...
15. Seed NZ chart and demo data:
    The default chart seed is now NZ-oriented and derived from the Xero-style chart reference, with explicit system-account role mappings populated during seed/bootstrap. Replace IRS Pub 583 seed/demo data with NZ examples in a later follow-up slice.
