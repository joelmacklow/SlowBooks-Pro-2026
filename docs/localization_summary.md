...
6. Harden payroll privacy/auth boundaries:
   NZ payroll processing, payslips, Employment Information export, and employee filing now exist, but app-wide auth/privacy hardening for payroll PII remains an explicit deferred slice.
