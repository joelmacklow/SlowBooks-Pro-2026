...
## Objective
Restore startup compatibility for environments whose database `alembic_version` points at the removed Bank Rules MVP revision `o5d6e7f8g9h0`, without reintroducing the whole unmerged Bank Rules feature onto this branch.
