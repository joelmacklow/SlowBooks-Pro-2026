...
(async () => {
    ...
    context.BankingPage._splitCodeAbsoluteAmount = 53.10;
    splitRows[0].percentInput.value = '85';
    context.BankingPage.splitCodePercentChanged(0);
    splitRows[1].percentInput.value = '15';
    context.BankingPage.splitCodePercentChanged(1);
    context.BankingPage.recalcSplitCode();
    assert.strictEqual(splitRows[0].amountInput.value, '45.14');
